...
module.exports = {
        events: async () => {
            try {
                const events = await Event.find() //populate finds ref in model and can display creator info
        ...
        createEvent: async (args) => {
            const event = new Event({
                ...
                creator: '5d3e7626a8a251dab937b7eb'
            });
            let createdEvent;
            ...
            try {
                ...
                const creator = await User.findById('5d3e7626a8a251dab937b7eb');
